...
> carries
> that formatting. Footnotes and a table's note are written but not yet published, nothing holds an
> equation, and nothing is cross-referenced yet.
...
| Footnotes                    | A footnote at the cursor in a paragraph, from the toolbar or `Ctrl+Alt+F`, written and formatted in an editor that opens beneath the text; not yet published                                                                                                                                                                                                                                                                               |
