...
> published, each publication set from the environment's theme.
...
| Tables                       | A table with a caption, header rows and columns and merged cells, from the toolbar or a paste, edited cell by cell and changed from a Table panel, with a note beneath it, and published under its numbered caption with its headers marked and repeated                                                                                                                                                                                                                                                                  |
...
| Figures                      | Make a figure from a PNG or JPEG on the toolbar, describing the image or marking it decorative as it is uploaded; caption it, change how it is described, replace its image or delete it from a Figure panel; published sized to the page, captioned and described to a screen reader, and listed after the contents. An image in a line of text - in a paragraph, a list or a table cell - from the Image button, published one line high                                                                                |
