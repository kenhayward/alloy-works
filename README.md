...
> published, each publication set from the environment's theme, its tables and images from their
> styles, and a document can be published to Word as well, or instead, all of it but its
> equations.
...
bar needs themes, templates, assets and tables as well as an editor. **The first pieces of it are built** - tenancy and sign-in, access control, components with immutable versions, a component's paragraphs edited, formatted and arranged into lists under a lock, documents whose outlines you restructure and whose sections are numbered, and a document published as a laid-out, tagged PDF that carries that formatting, those lists, its tables, its figures, its footnotes, its cross-references and its equations, set from a stored theme, and a Word document of all of that but its equations, in the theme's styles - on the scaffolding under them. Choosing or editing a theme, templates, search and the rest of Word are not, and the table below and [`docs/features.md`](docs/features.md) say exactly what is.
...
| Tables                       | A table with a caption, header rows and columns and merged cells, from the toolbar or a paste, edited cell by cell and changed from a Table panel, with a note beneath it, and published under its numbered caption with its headers marked, its rules, padding, header, banding and page breaks set by its table style in the theme                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| Images                       | Upload a PNG or JPEG into a space through the API, checked by its bytes and decoded whole before anything may use it, and read back by whoever may read the space                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| Figures                      | Make a figure from a PNG or JPEG on the toolbar, describing the image or marking it decorative as it is uploaded; caption it, change how it is described, replace its image or delete it from a Figure panel; published sized, placed and aligned by its image style in the theme, captioned and described to a screen reader, and listed after the contents. An image in a line of text - in a paragraph, a list or a table cell - from the Image button, published one line high                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| Footnotes                    | A footnote at the cursor in a paragraph, from the toolbar or `Ctrl+Alt+F`, written and formatted in an editor that opens beneath the text; published at the foot of its page with the document's number for it, and in Word as a real Word footnote numbered by Word                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| Cross-references             | A reference to a section, a figure, a table, a footnote or a numbered equation, from the toolbar or `Ctrl+Alt+X`, chosen in a dialog and shown as it will print, or as broken when its target has gone; kept through an undo and a cut and paste; published as its number, its title, both, its page, or above or below in the layout's words, a link in running text, and in Word as a field Word updates                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| Equations                    | An equation typed as LaTeX in a dialog, from the toolbar or `Ctrl+Shift+E`, and drawn as mathematics as you type, inline in any text or as a block of its own, numbered or not, and in a section's title in the outline, with the words a screen reader says written for you in the component's language and yours to change; published in STIX Two Math, read to a screen reader by those words, a numbered one with its number beside it                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| Documents and outlines       | Make a document in a space, build its outline out of sections and components, title a section with words and equations, and restructure it a version at a time. Sections are numbered as you go, with the scheme the document publishes with; a top-level part can be front matter, the body or an appendix; every part has a link, and figures, tables and equations are listed                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| Publishing a document        | Publish a document as a tagged PDF of its outline, its formatted paragraphs, its lists, its quotations, its preformatted text, its tables, its figures, its images in a line of text, its footnotes, its cross-references and its equations, laid out with a cover, a contents, lists of figures and tables, running heads and feet and pages numbered per part, set from the environment's theme, which it records, marked not approved on every page, kept, listed beneath the outline and downloaded from its own page; or as a Word document, or both, its paragraphs in the theme's styles as Word styles, its headings, figures, tables and footnotes numbered by Word, its cross-references fields Word updates, its lists, quotations, preformatted text, tables, figures and images as the PDF sets them, with the cover, contents, lists of figures and tables, running heads and feet and the Liberation typefaces embedded, what Word cannot carry of a table named on the publication's page, and equations, and the few references Word would print otherwise, refused for Word by name |
