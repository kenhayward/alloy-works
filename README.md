...
| Images                       | Upload a PNG or JPEG into a space through the API, checked by its bytes and decoded whole before anything may use it, and read back by whoever may read the space; nothing in the application places one yet                                                                                                                                                |
