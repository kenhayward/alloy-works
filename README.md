...
| The interface                | A dark header band with a module switcher, the environment and an account chip that signs out, over screens in the Light theme, built so another theme is only new colours                                                                                                                                                             |
