...
| Lists                        | Bulleted, numbered and definition lists from the toolbar or the keyboard, nesting to any depth and mixing kinds freely, with a definition list's term formatted like any other text and a panel for where a numbered list starts counting and how it counts                                                                            |
