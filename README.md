...
> styles, and a document can be published to Word as well, or instead, all of it but its footnotes,
...
| Footnotes                    | A footnote at the cursor in a paragraph, from the toolbar or `Ctrl+Alt+F`, written and formatted in an editor that opens beneath the text; published at the foot of its page with the document's number for it                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| Cross-references             | A reference to a section, a figure, a table, a footnote or a numbered equation, from the toolbar or `Ctrl+Alt+X`, chosen in a dialog and shown as it will print, or as broken when its target has gone; kept through an undo and a cut and paste; published as its number, its title, both, its page, or above or below in the layout's words, a link in running text                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
