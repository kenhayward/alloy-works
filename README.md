...
| Figures                      | Make a figure from a PNG or JPEG on the toolbar, describing the image or marking it decorative as it is uploaded; caption it, change how it is described, replace its image or delete it from a Figure panel; published sized to the page, captioned and described to a screen reader, and listed after the contents                                                                |
