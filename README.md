...
> carries
> that formatting. Nothing is arranged beyond those - no footnote or equation -
...
| Tables                       | A table with a caption, header rows and columns and merged cells, from the toolbar or a paste, edited cell by cell and changed from a Table panel, and published under its numbered caption with its headers marked and repeated                                                                                                                                                                                                           |
