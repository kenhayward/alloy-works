 ...
 * `listReadableComponents`, `listReadableDocuments` and `listPublications` all call this.
 *
 ...
 * of content lists only content kinds and publications, and `artifact_space_by_kind`
 * (0007_spaces_and_artifacts.sql, widened by 0016_documents.sql and 0017_publishing.sql) requires a
 * component, a document and a publication alike to carry a non-null `space_id`. A listing of
 * definitions, which live in no space, must not use this as it stands.
 */
