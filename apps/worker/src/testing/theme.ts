 ...
 * theme the store would refuse. At its 0.2, the version migration 0025 seeds and template 13 sets:
 * table and image styles, and a quotation set off by its own spaces and contextual spacing (themes 2,
 * ruling R3).
 */
