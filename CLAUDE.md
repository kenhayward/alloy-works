...
> in any paragraph, a table's cell's included, with the same dialog and panel. A
...
> publishes content: no image pasted from outside the product or published in a line of text, no footnote or equation written or pasted, no metadata panel,
