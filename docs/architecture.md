...
published, and every other inline item - an image, a footnote, a cross-reference and an equation. The theme, a list of equations in the default layout, veraPDF on every publication, preview and Word are later slices'. Nothing chooses or edits a
