...
| 2   | [Publishing tables](2026-09-22-tables-02-publishing-tables.md)               | `publishing/6` and template `publication/6` under `--features a11y-extras`, layout schema 2 with `matter.lists` and the default layout 0.2 declaring a list of tables, `table_without_caption`, a veraPDF regression case, and TAB-049 from #202                                                                                                 | Planned         |
