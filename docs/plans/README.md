...
| 2   | [Table and image styles](2026-09-24-themes-02-table-and-image-styles.md) | Table styles - header treatment, banding, rules, padding, header repetition, rows kept whole and a continued label in the layout's words; image styles - a fixed dimension, a maximum, placement and alignment; contextual spacing, and the quotation's set-off back | Built (PR #PRNUM) |
