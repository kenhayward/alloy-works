...
| 2   | [Lists, tables and figures in Word](2026-09-25-word-02-lists-tables-and-figures.md) | Lists nested to nine levels and definition lists, quotations spaced as the PDF's, preformatted text in separate panels, tables in their table style with marked header rows, captions numbered by Word, figures and inline images sized against the Word page, and the report's table entries                                  | In progress     |
