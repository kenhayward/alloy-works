...
nothing yet lets a tenant declare anything. It files one requirement, CNT-149, since nothing in the
corpus asked for creating a component.
...
idempotency key on creating (API-008); deleting a component, LIF's; and creating or renaming a space.
