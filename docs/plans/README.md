...
| 5   | [Publishing inline images](2026-09-23-figures-05-publishing-inline-images.md)       | An image in a line of text or a table cell published one line high, tagged with its alternative text in its language or as decorative, inside the paragraph or cell it stands in; one wider than its room refused              | In progress     |
