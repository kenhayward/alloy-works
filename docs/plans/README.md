...
| 4   | [Equations in Word](2026-09-26-word-04-equations.md)                                           | Every equation as a native Word equation from the maths tree, numbered by Word in a row of two cells, referenced and listed, the maths face reported; Word a first-class output                                                                                                                                                                   | In progress     |
