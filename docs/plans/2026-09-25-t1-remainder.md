...
| --- | ------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- | ----: | -------------------------------------------------- |
| W1  | **Test debt** - built, uncited                    | CNT-014, CNT-019, CNT-026, CNT-061, CNT-062, CNT-081, CNT-085, STR-024, VER-009, IAM-053, API-003, API-005, STY-019 (once reworded, K7), PUB-069, PUB-031, TAB-050, CNT-160, CNT-164, CNT-166, CNT-169, STR-068, IAM-078; and CNT-124, whose one citation shows only its first sentence                                | four need a design claim before a test may cite them: PUB-069 and PUB-031 in publishing.md, CNT-160 in structure.md, CNT-166 in content-model.md     |     2 | -                                                  |
| W2  | **Small fixes found by the audit**                | CNT-075, CNT-079, CNT-074, API-012, API-037, API-047, API-006, CNT-069 (history depth), PUB-003 (order, and its swap tests), CNT-167 (Word's footnotes kept on paste); and the design text the audit found stale: publishing.md's `citation_unresolved`, where veraPDF runs, and docs/features.md on the document view | claims to add first: CNT-075, CNT-079 and CNT-074 in component-editor.md, API-037 and API-047 in service-foundations.md, CNT-167 in content-model.md |     3 | -                                                  |
