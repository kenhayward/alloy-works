...
| --- | ------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------- | ----: | -------------------------------------------------- |
| W1  | **Test debt** - built, uncited                    | CNT-014, CNT-019, CNT-026, CNT-061, CNT-062, CNT-081, CNT-085, STR-024, VER-009, IAM-053, API-003, API-005, STY-019 (once reworded, K7), PUB-069, PUB-031, TAB-050, CNT-160, CNT-164, CNT-166, CNT-169, STR-068, IAM-078 | none                                                                                  |     2 | -                                                  |
| W2  | **Small fixes found by the audit**                | CNT-075, CNT-079, CNT-074, API-012, API-037, API-047, API-006, CNT-069 (history depth), PUB-003 (order, and its swap tests), CNT-167 (Word's footnotes kept on paste)                                                    | none                                                                                  |     3 | -                                                  |
...
| W5  | **Definitions and the metadata panel**            | MET-008, MET-012, MET-031, MET-037, MET-040, MET-041, MET-021, MET-033, MET-038, MET-023                                                                                                                                 | new: the management design metadata.md defers to; the panel is in component-editor.md |     4 | W4 for the document and section places             |
...
placement. Only K1 is needed this week; K2, K3 and K8 are needed before W10, W12 and W8.
...
through its review. So a week holds about 25 pull requests, not 50. This is the week's share; the
...
counting every built thing. **Left for the second week:** W2's Word paste footnotes, the metadata
panel's last slice, search,
listings, the theme in the editor, the document view, preview, recovery, identity, the browser suite,
and publishing's last rows - W5 to W14, about 28 PRs.
