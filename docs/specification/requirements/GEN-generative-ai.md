...
| **GEN-054** | A user must be able to save their own prompts to a personal prompt library, visible only to them, and to run one in a conversation. A personal prompt is not a tenant artifact: it must never be bound by a template (**TPL-052**) or run by anybody else                                                                                                                                                                                                              | T5         | Specified |
