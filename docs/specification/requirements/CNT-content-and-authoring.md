...
| Tracking the latest approved revision needs revisions (REU-050, LIF-038), which are T3                                                                                                            | **CNT-141 superseded by CNT-162** - the version referenced, pinned or floating, T1 - with **CNT-163**, a reference tracking the latest approved revision, in T3                                                                                             |
