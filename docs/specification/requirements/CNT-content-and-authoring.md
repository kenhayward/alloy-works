...
| **CNT-141** | The view must show which version or revision of a component is referenced, and which of the three modes the reference takes: pinned, floating at latest, or tracking the latest approved revision (**REU-050**, **LIF-038**) | T1      | Specified             |
