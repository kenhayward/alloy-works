...
| **CNT-114** | Preview must reflect an edit within one second, and never more than two, in a 300-page document - a provisional budget, to be confirmed against real content                                       | T1      | Specified |
