...
| **SCH-067** | New and changed content must become findable by meaning (**SCH-013**) within a stated interval, as a budget rather than a hope                                                                                           | T5         | Specified             |
...
| Finding by meaning is SCH-013's semantic search, which is T5                                     | **SCH-050 superseded by SCH-066** - findable by its words, T1 - with **SCH-067**, findable by meaning, in T5                                                                         |
