...
| **SCH-051** | Components, documents, sections, publications, templates, assets, query definitions, terms, threads, fields, metadata schemas and component types must all be searchable                                                                                     | T1      | Superseded by SCH-054 |
| **SCH-054** | Components, documents, sections, publications, templates, assets, fields, metadata schemas and component types must all be searchable                                                                                                                        | T1      | Specified             |
| **SCH-055** | Query definitions must be searchable                                                                                                                                                                                                                         | T2      | Specified             |
...
| **SCH-045** | A result must link by identity (**STR-046**). Where the target has moved, been superseded or been removed between indexing and the click, the reader must land on a named explanation, and on the newer version where one exists - never on a blank page. A result from an earlier version (SCH-003) must link to that version | T1         | Superseded by SCH-057 |
| **SCH-057** | A result must link by identity (**STR-046**). Where the target has moved, been superseded or been removed between indexing and the click, the reader must land on a named explanation, and on the newer version where one exists - never on a blank page                                                                       | T1         | Specified             |
| **SCH-058** | A result from an earlier version (SCH-003) must link to that version                                                                                                                                                                                                                                                           | T3         | Specified             |
...
| **SCH-063** | A field applied through a relationship type (**MET-034**, **REL-053**) must facet across the relationships that carry it                                                                                                                                                     | T4      | Specified             |
| **SCH-019** | Listing views must exist for documents, components, publications, templates and cohorts, with sorting and filtering                                                                                                                                                          | T1      | Superseded by SCH-064 |
| **SCH-064** | Listing views must exist for documents, components, publications and templates, with sorting and filtering                                                                                                                                                                   | T1      | Specified             |
| **SCH-065** | A listing view must exist for cohorts (**REU-034**), with sorting and filtering                                                                                                                                                                                              | T4      | Specified             |
...
| **SCH-067** | New and changed content must become findable by meaning (**SCH-013**) within a stated interval - provisionally p95 within 60 seconds, never above five minutes - as a budget rather than a hope                          | T5         | Specified             |
...
| What was found                                                                                   | Change                                                                                                                                                                                             |
| ------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Query definitions are **DAT**'s, in T2, terms **LIB**'s, in T6, and threads **COL**'s, in T3     | **SCH-051 superseded by SCH-054**, T1, with **SCH-055**, query definitions, in T2, and **SCH-056**, terms, in T6. Threads are already **SCH-038**, in T3, so no row is made for them               |
| Earlier versions are searchable only with SCH-003, which is T3                                   | **SCH-045 superseded by SCH-057** - linking by identity and landing on an explanation, T1 - with **SCH-058**, a result from an earlier version, in T3                                              |
| Workflow state is **LIF**'s, in T3, and condition values **REU**'s, in T4                        | **SCH-018 superseded by SCH-059**, T1, with **SCH-060**, workflow state, in T3, and **SCH-061**, condition value, in T4                                                                            |
| A field applied through a relationship type needs relationship types, which are **REL**'s, in T4 | **SCH-052 superseded by SCH-062** - at a component, a document or a section, T1 - with **SCH-063**, across relationships, in T4                                                                    |
| Cohorts (REU-034) are T4                                                                         | **SCH-019 superseded by SCH-064**, T1, with **SCH-065**, a listing of cohorts, in T4                                                                                                               |
| Finding by meaning is SCH-013's semantic search, which is T5                                     | **SCH-050 superseded by SCH-066** - findable by its words, T1 - with **SCH-067**, findable by meaning, in T5. Both keep its provisional budget, p95 within 60 seconds and never above five minutes |
