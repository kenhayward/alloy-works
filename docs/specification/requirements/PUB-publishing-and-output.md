...
| **PUB-Q02** | **Does Google Docs export survive at all?** It exists because customers ask for it and cannot express what the product is for                                                                     | Whether a customer wants it enough to accept it being visibly worse. Otherwise it is maintenance with no return     |
