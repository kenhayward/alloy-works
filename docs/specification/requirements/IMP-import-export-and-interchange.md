...
| **IMP-044** | An export artifact must itself be tenant-scoped and permissioned as the tenant's content, must be expirable or deletable, and its download must be audited (**IAM-075**, **ADM**)                                                                                                                                                                              | Constraint | Specified |
