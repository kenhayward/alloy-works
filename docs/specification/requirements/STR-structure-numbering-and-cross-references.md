...
| **STR-012** | The outline must be versioned with the document, and pinned by a baseline like anything else (**VER**)                                                                                                                                                                                                                                                                                                                                      | T1         | Superseded by STR-067 |
| **STR-067** | The outline must be versioned with the document: every change to it is a new version of the document                                                                                                                                                                                                                                                                                                                                        | T1         | Specified             |
...
| ID          | Requirement                                                                                                                                                                                                                                                                                                                                                                                                                                 | Tranche    | Status                |
| ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- | --------------------- |
| **STR-026** | A cross-reference must target an outline node, a caption-bearing block, a footnote, or a bibliography entry, by identity                                                                                                                                                                                                                                                                                                                    | T1         | Superseded by STR-068 |
| **STR-068** | A cross-reference must target an outline node, a caption-bearing block or a footnote, by identity                                                                                                                                                                                                                                                                                                                                           | T1         | Specified             |
| **STR-069** | A cross-reference must be able to target a bibliography entry, by identity (**LIB**)                                                                                                                                                                                                                                                                                                                                                        | T6         | Specified             |
...
| **STR-055** | A cross-reference whose display form is a page (STR-027) must render a declared alternative form in an output format that has no pages, and must fail the publish where none is declared - never a blank, and never a page number that means nothing                                                                                                                                                                                        | T6         | Specified             |
...
| ID          | Requirement                                                                                                                                                                                                                                                                                                                            | Tranche | Status                |
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- | --------------------- |
| **STR-034** | A navigable table of contents must reflect the live outline, and must update as the outline changes                                                                                                                                                                                                                                    | T1      | Superseded by STR-065 |
| **STR-065** | A navigable table of contents must reflect the outline, and must update as the author changes it                                                                                                                                                                                                                                       | T1      | Specified             |
| **STR-066** | The table of contents must update live as another person changes the outline                                                                                                                                                                                                                                                           | T3      | Specified             |
...
| **STR-050** | Page-break declarations must be ignored, without error, by output formats that have no pages | T6         | Specified |
...
| What was found                                                                        | Change                                                                                                                                                                                          |
| ------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| STR-050 needs an output without pages, and the only one planned is HTML (PUB-056, T6) | **STR-050 moved to T6**                                                                                                                                                                         |
| STR-055 is observable only with an output without pages, HTML (PUB-056, T6)           | **STR-055 moved to T6**                                                                                                                                                                         |
| Updating as another person changes the outline needs concurrent editing, which is T3  | **STR-034 superseded by STR-065** - the contents updating as the author changes the outline, T1 - with **STR-066**, updating live for another person's changes, in T3                           |
| Pinning by a baseline needs baselines, which are T3                                   | **STR-012 superseded by STR-067**, every change to the outline a new version of the document, T1. A baseline pinning the outline is already **VER-018**, a Constraint, so no row is made for it |
| A bibliography entry needs **LIB**, which is T6                                       | **STR-026 superseded by STR-068** - an outline node, a caption-bearing block or a footnote, T1 - with **STR-069**, a bibliography entry, in T6                                                  |
