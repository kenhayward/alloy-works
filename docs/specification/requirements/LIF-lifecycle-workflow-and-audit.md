...
| **LIF-038** | Passing a component's gate must designate a component revision (LIF-013), and a document must be able to reference a component at **its latest approved revision** as well as pinned or floating at latest (**CNT-110**)    | T3         | Specified |
...
| **LIF-041** | Where a newer revision of a component is approved, every document referencing its latest approved revision must be able to see that the reference has moved before a publish carries it (**CNT-108** to **CNT-110**)        | T3         | Specified |
