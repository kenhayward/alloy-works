...
| What was found                                                         | Change                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| ---------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Rotating, scaling and splitting are TAB-033's strategies, which are T2 | **TAB-041 superseded by TAB-050** - role, reading order and one table across a page break, T1 - with **TAB-051**, one table when rotated, scaled or split, in T2. TAB-050's clause about a table broken across pages is added, not carried over: TAB-041's "split" was TAB-033's strategy for a table too wide for its page, not a page break. A table breaking across pages as one table is measured in publishing.md's tagged-table cases |
