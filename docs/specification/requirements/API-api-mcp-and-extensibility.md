...
| ID          | Requirement                                                                                                                                                                                                                                                                                 | Tranche    | Status                |
| ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- | --------------------- |
| **API-025** | Content, workflow, review and publication events must be deliverable as webhooks                                                                                                                                                                                                            | T5         | Superseded by API-060 |
...
| **API-060** | Content, workflow, review, publication and notification events must be deliverable as webhooks. The inventory of events is owned by the areas that raise them - **COL-037**, **LIF**, **PUB** - and this area carries their delivery                                                        | T5         | Specified             |
...
| --------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 2.5, 2.9, 2.20, 2.21, 2.24, 3.2.8 | **API-054** re-checks authorisation on a live connection rather than only at connect. **API-055** makes webhook subscriptions administrable, audited and exportable. **API-056** takes the error and correlation contract corpus-wide, across jobs, webhooks, realtime messages, notifications and pipeline stages. **API-057** makes job and bulk submission safely retryable. **API-058** gives every listable thing a paging and cap contract. **API-059** covers extension installation, update and removal. **API-025 superseded by API-060**, which includes the notification events COL-037 always required |
