...
> [`Project_Scope.md`](../Project_Scope.md) section 7 - all twenty-one written. 1203 requirements,
> 112 non-requirements and 128 numbered questions, twenty-seven of which have since been settled. These say
