...
> [`Project_Scope.md`](../Project_Scope.md) section 7 - all twenty-one written. 1044 requirements,
> 102 non-requirements and 114 numbered questions, twenty-three of which have since been settled. These say
