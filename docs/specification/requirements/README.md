...
> [`Project_Scope.md`](../Project_Scope.md) section 7 - all twenty-one written. 897 requirements, 89
> non-requirements and 94 numbered questions, twenty-two of which have since been settled. These say
