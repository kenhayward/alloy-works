...
> [`Project_Scope.md`](../Project_Scope.md) section 7 - all twenty-one written. 879 requirements, 88
> non-requirements and 93 numbered questions, fifteen of which have since been settled. These say
