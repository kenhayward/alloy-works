...
> [`Project_Scope.md`](../Project_Scope.md) section 7 - all twenty-one written. 975 requirements, 96
> non-requirements and 105 numbered questions, twenty-three of which have since been settled. These say
