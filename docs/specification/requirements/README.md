...
> [`Project_Scope.md`](../Project_Scope.md) section 7 - all twenty-one written. 1088 requirements,
> 106 non-requirements and 119 numbered questions, twenty-five of which have since been settled. These say
