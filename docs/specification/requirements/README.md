...
> [`Project_Scope.md`](../Project_Scope.md) section 7 - all twenty-one written. 992 requirements, 98
> non-requirements and 107 numbered questions, twenty-three of which have since been settled. These say
