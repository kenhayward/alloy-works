...
> [`Project_Scope.md`](../Project_Scope.md) section 7 - all twenty-one written. 1061 requirements,
> 104 non-requirements and 115 numbered questions, twenty-three of which have since been settled. These say
