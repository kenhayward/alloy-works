...
> [`Project_Scope.md`](../Project_Scope.md) section 7 - all twenty-one written. 1167 requirements,
> 110 non-requirements and 126 numbered questions, twenty-seven of which have since been settled. These say
