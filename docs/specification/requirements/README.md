...
> [`Project_Scope.md`](../Project_Scope.md) section 7 - all twenty-one written. 1033 requirements,
> 100 non-requirements and 111 numbered questions, twenty-three of which have since been settled. These say
