...
> [`Project_Scope.md`](../Project_Scope.md) section 7 - all twenty-one written. 1115 requirements,
> 108 non-requirements and 122 numbered questions, twenty-six of which have since been settled. These say
