...
| 4   | **Search infrastructure**     | Whether full-text and semantic search are one system or two, and how the permission filter is applied at query time without leaking existence                                                                                                                                                                                                                    |
| 5   | **Relationship storage**      | Recursive SQL or a graph store. Hinges on realistic traversal depth and volume                                                                                                                                                                                                                                                                                   |
| 6   | **Realtime transport**        | Presence, locks, notifications and streaming, and whether one channel serves all four                                                                                                                                                                                                                                                                            |
