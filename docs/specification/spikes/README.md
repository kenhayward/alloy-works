...
| [Editor framework](Editor_Framework_Spike.md)                                                     | Which editor the stored model is the editor's model of, and what it imposes on that model | **Not yet run.** Proposed 2026-09-13, before the content model becomes code                                                                                           |
