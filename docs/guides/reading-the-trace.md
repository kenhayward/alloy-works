...
This repository holds 1,303 product requirements. Every one of them has an identifier, and the point
...
| ------------------------------------------------------------ | ------------------------------------------------------------------------------------------------- |
| What does this product claim to do?                          | [`../specification/requirements/`](../specification/requirements/) - 1,303 requirements, 21 areas |
...
1,303 is not an error. This product is scaffolding: it can sign in, isolate a tenant, run a job and
