...
This repository holds 1,368 product requirements. Every one of them has an identifier, and the point
...
| ------------------------------------------------------------ | ------------------------------------------------------------------------------------------------- |
| What does this product claim to do?                          | [`../specification/requirements/`](../specification/requirements/) - 1,368 requirements, 22 areas |
...
**`0.13.0` declares seven requirements and excludes four, each with a stated reason.** Seven out of 1,368 is not an error. When it was declared the product was scaffolding: it could sign
