...
| **VER-056** | One versioning mechanism parameterised by `artifact_kind`, so documents - one kind, whose content is the outline - assets, themes, layouts and templates share it                                                                                                                  |
