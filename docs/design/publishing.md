...
2. **The layout.** The layout artifact and its default version; running heads and feet; page
   ...
   scheme to the numbering route and the panel; a request made under the layout, in its language.
   Lands #144 as PUB-095. Cites PUB-007 to PUB-009, PUB-011, PUB-012, PUB-014, PUB-095,
