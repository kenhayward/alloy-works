...
now hold one**: body text saying "see Section 4.2" is the commonest reference there is, and STR-026's
gap above is exactly that. A node belongs to one document's outline, so such a reference resolves in
