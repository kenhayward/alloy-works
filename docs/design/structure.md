...
STR-026 stays claimed although the built target union has no bibliography entry yet: LIB has not said
what an entry's identity is, and adding the kind changes nothing stored. STR-062 is answered here as
