...
| Cross-reference                                                                 | Yes, from a dialog: in a document, over its sections and its components' figures, tables and footnotes; on its own, over its own (structure.md, XR-A) | Target and display form; removal                                                       | Designed on 2026-09-23 (structure.md, [Making, showing and printing a reference](structure.md#making-showing-and-printing-a-reference)); built in two slices (XR-G) |
...
- **Its paragraphs are edited inline** (FN-E), beneath the paragraph the mark stands in, in a nested
  ...
  equations, citations and cross-references wait for their own slices. What it holds is the footnote's
